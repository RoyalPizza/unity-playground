...
namespace Pizza.Runtime
{
    ...
    /// </remarks>
    public class PizzaScriptableObject : ScriptableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// This works the same as OnValidate, but is called when the scriptable object
        /// is selected, or via editor code.
        /// </summary>
        public virtual void OnCustomValidate()
        {
#if UNITY_EDITOR
            //Debug.Log($"PizzaScriptableObject::OnCustomValidate was called on {name}.", this);
#endif
